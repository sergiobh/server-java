...
public class BancoTest {
    ...
    @Before
    public void setUp() {
        banco = new Banco("Sergio", 31218428);
    }
    ...
    public void testAdicionaConta() throws Exception {
        ...
        try {
            ...
            try {
                ...
                assertEquals("Número máximo de contas atingido", bancoException.getMessage());
            } catch (Exception e) {
    ...
    public void testRetornaValoresDaDividaDoEmprestimoPelaConta() {
        ...
        try {
            ...
            double[] emprestimos = new double[]{
                1035.00, 3172.50, 7706.25
            };

            /*
             * Conforme orientado o valor 7687.50 nao é o válido e sim 7706.25
             */
            ...
            try {
                ...
                assertEquals("Número máximo de emprestimos concedidos", emprestimoException.getMessage());
            } catch (Exception e) {
                fail("Exceção: " + e.getMessage());
            }
